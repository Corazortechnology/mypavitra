...
export function MaterialArt() {
  return (
    <>
      <defs>
        <linearGradient id="m-brass" x1="0%" y1="0%" x2="100%" y2="100%">
        ...
        <linearGradient id="m-copper" x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" stopColor="#e0a074" />
          <stop offset="50%" stopColor="#b06a3c" />
          <stop offset="100%" stopColor="#6f3c1e" />
        </linearGradient>
        <linearGradient id="m-spec" x1="0%" y1="0%" x2="100%" y2="0%">
        ...
        <radialGradient id="m-vessel" cx="42%" cy="34%" r="72%">
      ...
      <g className="mat-surface">
        <rect x="0" y="0" width="2000" height="1200" fill="url(#m-brass)" />
      ...
      <rect className="mat-copper" x="1200" y="0" width="800" height="1200" fill="url(#m-copper)" opacity="0" />

      {/* Specular sweep */}
      <polygon className="mat-spec" points="-300,0 200,0 700,1200 200,1200" fill="url(#m-spec)" opacity="0.5" />

      {/* Lathe spokes — revealed on pull-back */}
      <g className="mat-wheel" stroke="#fbe7bb" strokeOpacity="0.18" strokeWidth="2" opacity="0">
      ...
      <g className="mat-vessel" opacity="0">
