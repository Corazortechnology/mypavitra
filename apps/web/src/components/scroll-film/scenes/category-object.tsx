...
function Diya() {
  return (
    <g>
      ...
      <path d="M250 470 C 280 540 340 566 400 566 C 460 566 520 540 550 470 C 512 494 448 502 400 502 C 352 502 288 494 250 470 Z" fill="url(#co-brass)" />
      <ellipse cx="400" cy="470" rx="150" ry="30" fill="url(#co-rim)" />
...
function Thali() {
  return (
    <g>
      ...
      <ellipse cx="400" cy="440" rx="300" ry="104" fill="url(#co-brass)" />
      <ellipse cx="400" cy="440" rx="300" ry="104" fill="none" stroke="url(#co-rim)" strokeWidth="10" />
...
function Bell() {
  return (
    <g>
      ...
      <path d="M300 560 Q300 360 400 360 Q500 360 500 560 Z" fill="url(#co-brass)" />
      <ellipse cx="400" cy="560" rx="100" ry="24" fill="url(#co-rim)" />
      <rect x="388" y="250" width="24" height="112" rx="12" fill="url(#co-brass)" />
      <circle cx="400" cy="240" r="30" fill="url(#co-rim)" />
    </g>
  );
}
...
function Incense() {
  return (
    <g>
      ...
      <rect x="300" y="540" width="200" height="30" rx="14" fill="url(#co-brass)" />
...
function Kit() {
  return (
    <g>
      ...
      {/* basket */}
      <path d="M230 430 L570 430 L536 600 L264 600 Z" fill="url(#co-brass)" />
      <ellipse cx="400" cy="430" rx="170" ry="46" fill="#b78f45" />
      <ellipse cx="400" cy="430" rx="170" ry="46" fill="none" stroke="url(#co-rim)" strokeWidth="8" />
      {/* contents */}
...
const MAP: Record<ObjectKey, () => ReactElement> = {
  diya: Diya,
  thali: Thali,
  bell: Bell,
  incense: Incense,
