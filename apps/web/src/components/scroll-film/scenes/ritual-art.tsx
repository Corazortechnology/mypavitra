...
export function RitualArt() {
  return (
    <>
      ...
      {/* Ground vignette */}
      <rect x="-200" y="-200" width="2000" height="1400" fill="url(#r-spot)" />

      {/* Thali plate */}
      <g className="ro-thali">
        <ellipse cx="800" cy="770" rx="420" ry="70" fill="#000" opacity="0.32" />
        <ellipse cx="800" cy="650" rx="392" ry="132" fill="url(#r-brass)" />
        <ellipse
          cx="800"
          cy="650"
          rx="392"
      ...
      <g className="ro-incense">
        <rect x="676" y="486" width="120" height="18" rx="8" fill="url(#r-brass)" />
      ...
      {/* Bell (right) */}
      <g className="ro-bell">
        <path d="M956 560 Q956 470 1004 470 Q1052 470 1052 560 Z" fill="url(#r-brass)" />
        <ellipse cx="1004" cy="560" rx="48" ry="12" fill="url(#r-rim)" />
        <rect x="998" y="420" width="12" height="52" rx="6" fill="url(#r-brass)" />
        <circle cx="1004" cy="414" r="14" fill="url(#r-rim)" />
      </g>
      ...
      <g className="ro-diya">
        <path
          ...
          fill="url(#r-brass)"
        />
        <ellipse cx="640" cy="596" rx="80" ry="16" fill="url(#r-rim)" />
      ...
      <g className="ro-flowers" fill="url(#r-marigold)">
        <g>
